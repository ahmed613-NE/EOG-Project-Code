...
%%
% EyePeakValue = [41 78 112 135 -70 -95 -140 -180 ];
% EyeRotationValue = [100 110 120 130 80 70 60 50]; %positive is right

EyePeakValue = [-181 -177 -157 -114 -61 85 131 152 176 212 239];
EyeRotationValue = [40 50 60 70 80 100 110 120 130 140 150]; %positive is left


degreeofpolyfit = 1;
% keyboard
% LinedupResultSum(:,5) = normalize(LinedupResultSum(:,5),'norm');
Model = polyfit(EyePeakValue,EyeRotationValue,degreeofpolyfit)
